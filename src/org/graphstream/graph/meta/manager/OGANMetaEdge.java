...
public class OGANMetaEdge extends MultiEdge implements MetaEdge {
	...
	public OGANMetaEdge(Graph sharedGraph, String edgeId, OGANMetaNode source,
			OGANMetaNode target, boolean directed) {
	...
	public void addEdge(String edgeId) {
		if (MetaGraph.debug)
			System.out.printf("[meta] metaedge \"%s\", addedge \"%s\"%n",
					getId(), edgeId);
	...
	public void removeEdge(String edgeId) {
		if (MetaGraph.debug)
			System.out.printf("[meta] metaedge \"%s\", removeedge \"%s\"%n",
					getId(), edgeId);
