...
public class OGANMetaNode extends MultiNode implements MetaNode {
	...
	public Edge addEdge(String edgeId, String sourceNodeId,
		...
		if (MetaGraph.debug)
			System.out
					.printf("[meta] metanode \"%s\", addedge \"%s\" from \"%s\" to \"%s\"%n",
							getId(), edgeId, sourceNodeId, targetNodeId);

		Edge e = sharedGraph.getEdge(edgeId);

		if (e == null)
			e = sharedGraph.addEdge(edgeId, sourceNodeId, targetNodeId,
					directed);
	...
	public void removeEdge(String edgeId) {
		if (MetaGraph.debug)
			System.out.printf("[meta] metanode \"%s\", removeedge \"%s\"%n",
					getId(), edgeId);
	...
	public void removeNode(String nodeId) {
		if (MetaGraph.debug)
			System.out.printf("[meta] metanode \"%s\", removenode \"%s\"%n",
					getId(), nodeId);
