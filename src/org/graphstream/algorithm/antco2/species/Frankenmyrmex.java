...
// Constructors
	...
	public Frankenmyrmex( String id, Colony colony, AntCo2Node startNode, AntContext context )
	{
	...
	public void step()
	{
		...
		else
		{
			for( int i=0; i<nEdges; ++i )
			{
				...
				totalPop       += ((AntCo2Node)edge.getOpposite( curNode )).getAntCountForColor( colony );;
			}
