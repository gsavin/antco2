 ...
 * Vincomyrmex.
 * 
 * Changements par rapport a la fourmi décrite dans les articles. - La fourmi ne
 * considère que les proportions de PH sur les arcs, pas les valeurs. - La
 * fourmi considère qu'un arc sans phéromones est très attractif: politique
 * d'exploration. - La fourmi saute si elle détecte que tous les arcs autours
 * d'elle sont surpeuplés.
 * 
 * @author Antoine Dutot
 * @since 15 août 2005
 */
public class Vincomyrmex extends Ant {
	// Attributes
	...
	public Vincomyrmex(String id, Colony colony, AntCo2Node startNode,
			AntContext context) {
	...
	public void step() {
		...
		// int curPop = ((NodeInfos)curNode.getAttribute(
		// NodeInfos.ATTRIBUTE_NAME )).getAntCountForColor( color );
		// boolean jump = false;
		//
		...
		// }
			...
			if (params.perColorOverpop)
				...
				totalS += ((AntCo2Node) curNode).getTotalAntCount();
