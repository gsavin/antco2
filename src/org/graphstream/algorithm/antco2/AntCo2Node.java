	...
	extends AdjacencyListNode
{
	...
	/**
	 * Is this node on the membrane of its organization.
	 * If true, this means that at least one of its neightbor is not
	 ...
	 * @param colony initial node colony
	 * @param g graph
	...
	/**
	 * Submit a new color for the node.
	 * This can be overriden by subclasses to introduce
	 * mechanisms between color-submission and color-changes.
	 * @param ctx
	 * @param newColor
	 */
	...
	protected void checkColorChange( AntContext ctx )
	{
		...
		if( maxIndex >= 0 )
		{
			...
			else System.err.printf("warning: newcolor is null\n");
			*/
		...
		if( secondMaxIndex >= 0 )
		{
			...
			else System.err.printf("warning: second newcolor is null\n");
		}
	}
